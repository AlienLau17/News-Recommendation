...
class initface():
    def __init__(self, master):
        ...
        self.initface.pack()
        btn1 = tk.Button(self.initface, text='sport', width=15, height=2, command=partial(self.change, 'sport'))
        btn1.pack()
        btn2 = tk.Button(self.initface, text='health', width=15, height=2, command=partial(self.change, 'health'))
        btn2.pack()
        btn3 = tk.Button(self.initface, text='general', width=15, height=2, command=partial(self.change, 'general'))
        btn3.pack()
        btn4 = tk.Button(self.initface, text='science', width=15, height=2, command=partial(self.change, 'science'))
        btn4.pack()
        btn5 = tk.Button(self.initface, text='business', width=15, height=2, command=partial(self.change, 'business'))
        btn5.pack()
        btn6 = tk.Button(self.initface, text='technology', width=15, height=2, command=partial(self.change, 'technology'))
        btn6.pack()
        btn7 = tk.Button(self.initface, text='entertainment', width=15, height=2, command=partial(self.change, 'entertainment'))
        btn7.pack()
