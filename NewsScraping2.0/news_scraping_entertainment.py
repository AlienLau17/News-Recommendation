...
run_time = 13 # hours
category = 'h_entertainment'
date = time.strftime('%Y_%m_%d_%H_', time.localtime(time.time()))

file_name = date + str(run_time) + category + '.csv'
# api:XW2
api_url_us ='https://newsapi.org/v2/top-headlines?country=US&category=entertainment&apiKey=e6c9942383724370bc0d992c38aab180'
api_url_gb ='https://newsapi.org/v2/top-headlines?country=GB&category=entertainment&apiKey=e6c9942383724370bc0d992c38aab180'
api_url_ca ='https://newsapi.org/v2/top-headlines?country=CA&category=entertainment&apiKey=e6c9942383724370bc0d992c38aab180'
api_url_au ='https://newsapi.org/v2/top-headlines?country=AU&category=entertainment&apiKey=e6c9942383724370bc0d992c38aab180'
