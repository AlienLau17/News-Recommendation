...
# api:a3
api_url_us ='https://newsapi.org/v2/top-headlines?country=US&category=science&apiKey=ddd018fc8dc940f7afd952f816418855'
api_url_gb ='https://newsapi.org/v2/top-headlines?country=GB&category=science&apiKey=ddd018fc8dc940f7afd952f816418855'
api_url_ca ='https://newsapi.org/v2/top-headlines?country=CA&category=science&apiKey=ddd018fc8dc940f7afd952f816418855'
api_url_au ='https://newsapi.org/v2/top-headlines?country=AU&category=science&apiKey=ddd018fc8dc940f7afd952f816418855'
...
with open(file_name, 'w+') as csv_file:
    ...
    writer.writerow(['url', 'title', 'description', 'urlToImage', 'category'])
...
# for h in range(2):
    ...
    # for i in range(1):
        ...
        sleep(900) # Scraping news per 15 minutes
