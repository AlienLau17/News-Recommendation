...
run_time = 15 # hours
category = 'entertainment_'
date = time.strftime('%Y_%m_%d_%H_', time.localtime(time.time()))

file_name = category + date + str(run_time) + 'h.csv'

api_url_us ='https://newsapi.org/v2/top-headlines?country=US&category=entertainment&apiKey=b30f535c6b624930bb419501ba02cece'
api_url_gb ='https://newsapi.org/v2/top-headlines?country=GB&category=entertainment&apiKey=b30f535c6b624930bb419501ba02cece'
api_url_ca ='https://newsapi.org/v2/top-headlines?country=CA&category=entertainment&apiKey=b30f535c6b624930bb419501ba02cece'
api_url_au ='https://newsapi.org/v2/top-headlines?country=AU&category=entertainment&apiKey=b30f535c6b624930bb419501ba02cece'
